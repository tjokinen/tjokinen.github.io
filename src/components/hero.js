        ...
        <div className="grid grid-cols-2 gap-8 items-center">
          <div className="text-slate-950 space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                {/* Name */}
                <h1 className="z-10 font-raleway font-medium text-[1.8rem]/[0.8] min-[440px]:text-[3rem]/[0.8] md:text-[4rem]/[0.8] lg:text-[5.5rem]/[0.8] tracking-[-0.04em] mb-0 md:mb-4">
                  Tomi<br />Jokinen
                </h1>

                <div>
                  {/* Title */}
                  <h2 className="z-10 font-raleway font-normal text-[0.6rem]/[0.8] md:text-3xl lg:text-[47.78px] md:leading-[0.5] tracking-[0.06em] mt-1 md:mt-2 mb-1 md:mb-2">
                    Mobile Developer
                  </h2>

                    {/* Description */}
                    <p className="font-raleway font-normal text-[0.5rem]/[1.2] sm:text-[0.8rem]/[1.2] md:text-[1rem]/[1.4] tracking-[-0.02em] max-w-xl z-50 relative bg-argent/50 rounded-lg p-[0.2rem] sm:mt-2">
